    ...
    app.innerHTML = `
        <section class="about-section">
            ...
            <div class="about-flex">
                <img 
                    src="/api/download?file=images/about.png&mode=open" 
                    alt="About image" 
                    class="about-image" 
                />
                <p>
            ...
            <div class="developer-card">
                ...
                <p>
                    ...
                    practical tech solutions for schools and interested institutions.
                </p>
...
app.innerHTML =   <div class="contact-section">   <h2>Request a Book / Paper</h2>   <p>If you want a specific book, pamphlet, or exam paper added to the library, reach out:</p>   <ul>   <li>Email:    <a href="mailto:wycliffemwanganda@gmail.com">Email me</a>   </li>   <li>WhatsApp:    <a href="https://wa.me/265984153455" target="_blank">Let's talk</a>   </li>   </ul>   </div>  ;
}
